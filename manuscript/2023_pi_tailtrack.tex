...
Code for generating the figure panels in \autoref{fig:3} can be found in:  \href{https://github.com/owenrandlett/pi_tailtrack/blob/main/plot_tail.ipynb}{plot\_tail.ipynb}
...
Code for generating the figure panels in \autoref{fig:4} can be found in: \href{https://github.com/owenrandlett/pi_tailtrack/blob/main/gcamp_corr_swimming.ipynb}{gcamp\_corr\_swimming.ipynb}. Images output from the analysis were adjusted for brightness/contrast and LUT using FIJI/ImageJ \citep{Schindelin2012-hd}.
